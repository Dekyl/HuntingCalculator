...
class DataFetcher(QObject):
    ...
    def __init__(self, loot_ids: list[str], elixir_ids: list[str], region: str, language: str, lighstones_ids: list[str], imperfect_lightstone_ids: list[str]):
        """
        Initialize the DataFetcher with the necessary parameters.
            ...
            :param lighstones_ids: List of lightstone IDs.
        ...
        self.lighstones_ids = lighstones_ids
    ...
    def run(self):
        ...
        """
        self.data_retrieved, self.lightstone_costs, self.imperfect_lightstone_costs = connect_api(self.loot_ids, self.elixir_ids, self.lighstones_ids, self.imperfect_lightstone_ids, self.region, self.language)
